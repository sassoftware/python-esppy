...
class UnionWindow(Window):
    ...
    strict : bool, optional
        When false, specifies to use rewrite, insert, or update on inputs
        to upsert.
    ...
    strict = attribute('strict', dtype='bool')
    ...
    def __init__(self, name=None, pubsub=None, description=None,
                 ...
                 index_type=None, pubsub_index_type=None, strict=None):
